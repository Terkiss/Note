...
|---|:--:|:---:|
|px|픽셀| 화면 필셀|
| dp 또는 dip | 밀도 독립적 필셀(density independent pixel) | 160dpi 화면을 기준으로한 픽셀 <br> 예) 1인치당 160개의 점이 있는 디스플레이 ㅎ롸면에서 1dp는 1px 와 같음, 1인치당 320개의 점이 있는 디스플레이 화면에서 1dp 는 2px 와 같음 |
||||
||||
||||
