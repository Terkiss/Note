...
<h2>뷰( View)</h2> <br> 화면에 보이는 각각의 것들(버튼, 텍스트 등등)<br> 흔히 콘트롤(Controls) 이나 위젯(Widget)이라 불리는 UI구성요소<br> <h2>뷰그룹 (View Group)</h2> <br> 뷰들을 여러개 포함하고 있는것 <br> 뷰그룹도 뷰에서 상속하여 뷰가됨 즉 위의 뷰는 버튼만 아니라 이것들을 포함하는 눈에 보이지 않는 영역|<img 
